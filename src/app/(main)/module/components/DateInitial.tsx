...
export default function DateInitial({ required = false }: Props) {
    ...
    return (
        <div className="w-full gap-2 flex flex-column justify-content-center align-content-center">
            ...
            <Calendar required={required} name="date" placeholder={dictionary.DateFormat} showIcon className="border-round-xl border-none bg-bluegray-900" />
        </div>
    );
}
